...
# rebeccapurple https://www.w3.org/TR/css-color-4/#valdef-color-rebeccapurple
PEN_COLOR = '#663399'
PEN_WIDTH = 2
...
class Turtle:
    def __init__(
        ...
        self.position = Point(self.drawing.width // 2,
...
def make_turtle(
    *, auto_render=True, delay=None, width=DRAW_WIDTH, height=DRAW_HEIGHT
    ...
    _main_turtle = Turtle(auto_render=auto_render,
                          delay=delay, drawing=drawing)
    return _main_turtle
